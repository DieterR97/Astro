  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={styles.frameContainer}>
        <Frame title="Current Level" content="12" description="Cosmic Explorer" icon={ShipIcon} />
        <Frame title="Interest Rate" content="1%" description="Next -> 2%" icon={StatsIcon} />
        <Frame title="Transaction Fee" content="5 Coins" description="Per Transaction" icon={StackIcon} />
        <Frame title="Next Upgrade" content="Not Yet" description="CNeed 15 more Coins" icon={LevelIcon} />
      </div>
    </div>
  );
};
